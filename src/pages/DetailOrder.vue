  ...
  export default {
      ...
      created() {
          this.getOrderByIdentify(this.identify)
                  ...
                  .catch(response => {
                        toast.error('Falha ao Buscar Os Pedidos', 'Erro')
      ...
      methods: {
          ...
          sendEvaluation () {
            ...
            this.evaluationOrder(params)
                .then(response => {
                  this.toast.success('Avaliação enviada com sucesso', 'Parabéns')
                  this.order.evaluations.push(response.data.data)
                  this.closeModalEvaluation()
                })
                .catch(error => this.toast.error('Falha enviar avaliação', 'Erro'))
