        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-2 text-center">
                            <img class="img-responsive" src="@/assets/imgs/acai.png" alt="preview" width="120" height="80">
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-2 text-center">
                            <img class="img-responsive" src="@/assets/imgs/pizza.png" alt="preview" width="120" height="80">
                    </div>
                    <div class="col-12 text-sm-center col-sm-12 text-md-left col-md-6">
